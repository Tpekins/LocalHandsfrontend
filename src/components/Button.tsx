...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-secondary text-gray-800 hover:bg-yellow-400 focus:ring-secondary',
    ...
    icon: 'bg-transparent text-gray-500 hover:bg-gray-100 focus:ring-primary rounded-full',
  };
