...
const JobDetailsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (!jobId) return;
    api
      .get<ServiceOrder>(`/serviceorder/${jobId}`)
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <Card className="bg-lightGray p-5 space-y-4">
              <h3 className="text-lg font-poppins font-semibold text-gray-800 border-b pb-3">
                Job Overview
              </h3>
              ...
              <div className="pt-4">
                <Link
                  to={`/provider/submit-proposal/${job.id}`}
                  className="w-full"
                >
