...
/*
 * ProviderChatPage — GET /api/messages + POST /api/messages
 *
 * Same connection as ClientChatPage. Messages are fetched for the current
 * provider user and grouped into conversations by the other participant.
 * The backend Message model stores: senderId, receiverId, content, timestamp
 * with User relations via "SentMessages" and "ReceivedMessages".
 */
...
const ProviderChatPage: React.FC = () => {
  ...
  /** Group raw messages by the other participant to build conversation list */
  ...
  /** Fetch sent + received messages for the current user */
